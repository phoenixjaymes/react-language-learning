...
const DeConjunctions = ({ heading }) => (
  <div className="grammar__container">
    ...
    <DefinitionList definitions={conjunctionLists.nl.coordinate} />

    <h2>Subordinate Conjunctions</h2>
    <DefinitionList definitions={conjunctionLists.nl.subordinate} />

    {/* <h2>Compound Conjunctions</h2>
    <DefinitionList definitions={conjunctionLists.nl.compound} /> */}
