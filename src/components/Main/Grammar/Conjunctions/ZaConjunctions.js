...
const DeConjunctions = ({ heading }) => (
  <div className="grammar__container">
    ...
    <DefinitionList definitions={conjunctionLists.za.coordinate} />

    <h2>Subordinate Conjunctions</h2>
    <DefinitionList definitions={conjunctionLists.za.subordinate} />

    <h2>Compound Conjunctions</h2>
    <DefinitionList definitions={conjunctionLists.za.compound} />
