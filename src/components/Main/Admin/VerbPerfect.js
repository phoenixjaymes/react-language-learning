...
class VerbPerfect extends Component {
  ...
  render() {
    ...
    const {
      ...
      itemType, itemAuxiliary, response, status,
    } = this.state;
      ...
      <div>
        <div className="layout-grid-form">
          <form className="form" autoComplete="off" onSubmit={this.handleSubmit} onFocus={this.handleFocus}>
            <h3 className="form__header">Update German Perfect</h3>
            ...
            <label className="form__label--check" htmlFor="upPerfectAuxiliaryHaben">
              <input
                ...
                type="radio"
                value="haben"
                checked={itemAuxiliary === 'haben'}
                onChange={this.handleChange}
              />
              Haben
            </label>

            <label className="form__label--check" htmlFor="upPerfectAuxiliarySein">
              <input
